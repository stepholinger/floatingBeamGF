function [L, f_max, t_max, h_i, h_w, stat_dist, t0, source, mode, h_c_initial, h_c_final,...
          ...
          sigma, num_iterations, L_type, data_path, fs, event_bounds] = hydrostatic_moment_big_shear_fixed_distance()
...
stat_dist_step = 0;
t0_step = 0.66;
h_c_initial_step = 0.033;
h_c_final_step = 0.033;
...
fs = 100;
data_path = "/media/Data/Data/PIG/MSEED/noIR/PIG2/HHZ/2012-03-26.PIG2.HHZ.noIR.MSEED";
hour = 8;
minute = 54;
second = 26;
